...
internal class IntegrationTest
{
    ...
    public void TestBundle()
    {
        ...
        var sender1 = new CoreOSC.UDPSender(Constants.TestAddress, Constants.TestPort);
        ...
        Assert.AreEqual(4, recv.Messages[0].Arguments.Length);
        ...
        Assert.AreEqual(4, recv.Messages[1].Arguments.Length);
